 ...
 *    Without .class: UserController c = (UserController) container.getBean("controller");
 *    With .class: UserController c = container.getBean("controller", UserController.class);
